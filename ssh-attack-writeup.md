...
## Findings
Detected repeated SSH login attempts targeting port 22 from a suspicious external IP address. Investigated the IP address and found it was associated with multiple known cyber attacks.
